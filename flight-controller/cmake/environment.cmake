macro(set_toolchain ARCH)
    if(${ARCH} STREQUAL "x86")
        ...
        set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-std=c11 -D_POSIX_C_SOURCE=200809 -Wall -Wextra")
    ...
    elseif(${ARCH} STREQUAL "arm")
        ...
        # Set linker script.
        set(CMAKE_EXE_LINKER_FLAGS ${CMAKE_EXE_LINKER_FLAGS} "-T ${FLIGHTCONTROLLER_PATH}/src/board/${FLIGHTCONTROLLER_BOARD}/${FLIGHTCONTROLLER_BOARD}.ld")
